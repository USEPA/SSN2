...
```{r steam-network, fig.cap="Middle Fork 2004 stream networks. Observed sites are represented by brown, closed circles. Prediction sites are represented by blue, closed triangles.", out.width="85%", fig.align="center", warning=FALSE}
library(ggplot2)
ggplot() +
...
```{r steam-preds, fig.cap="Predicted Middle Fork 2004 mean summer temperatures (Celsius) spaced one kilometer apart. ", out.width="85%", fig.align="center", warning=FALSE}
ggplot() +
    geom_sf(data = mf04p$edges) +
