...
```{r, fig.cap="Middle Fork 2004 stream newtork. Observed sites are represnted by brown, closed circles. Prediction sites are represented by black, closed circles.", out.width="75%"}
library(ggplot2)
ggplot() +
...
```{r}
augment(ssn_mod, newdata = "pred1km", interval = "prediction")
```
