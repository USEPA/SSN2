...
#'    \item{pred1km: }{point shapefile representing prediction site
...
#' locations at approximately 1km intervals throughout the stream
#' network} }
#'
...
#'     \item{MaxOver20: }{Binary variable: 1 represents the maximum summer temperature was greater than 20C and 0 indicates that it was less than 20C}
