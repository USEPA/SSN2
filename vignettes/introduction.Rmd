---
title: "An Introduciton to Modeling Spatial Stream Networks Using SSN2"
...
These two models have different likelihoods, so we can't use AIC or AICc directly to compare them. We can, however, compare them using leave-one-out cross validation by running
```{r}
