...
[@kattwinkel2020openSTARS], which leveraged GRASS GIS. Pre-processing using either `SSNbler`, STARS, or `openSTARS` yields a non-proprietary `.ssn` folder (i.e., directory) which contains all
